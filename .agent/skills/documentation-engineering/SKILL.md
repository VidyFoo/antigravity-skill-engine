...
description: Create, maintain, and structure clear technical documentation. Follows the Diátaxis framework (Tutorials, How-To, Reference, Explanation) and Google Developer Style Guide. Use when asked to write READMEs, docs, guides, or comments.
---
